...
echo "Fetching model info: http://www.brother.com/pub/bsc/linux/infs/${model_clean:u}"
...
echo "Fetching CUPS wrapper source: $cups_src_tgz_url"
...
echo "Fetching LPR driver: $lpr_deb_url"
...
echo "Fetching CUPS wrapper .deb: $cupswraper_url"
...
echo "Fetching generic ARM driver: http://download.brother.com/welcome/dlf103361/$generic_deb"
